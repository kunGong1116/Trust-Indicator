...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateMetadataOnPage(metadata) {
    ...
    const imageLength =
      metadata["ImageLength"] !== "None" ? metadata["ImageLength"] : "None";
    ...
    const LatitudeRef =
      metadata["LatitudeRef"] !== "None" ? metadata["LatitudeRef"] : "No Ref";
    const Latitude =
      metadata["Latitude"] !== "None" ? metadata["Latitude"] : "No Latitude";
    ...
    const LongitudeRef =
      metadata["LongitudeRef"] !== "None" ? metadata["LongitudeRef"] : "No Ref";
    const Longitude =
      metadata["Longitude"] !== "None" ? metadata["Longitude"] : "No Longitude";
